![image-20191230102022829.png](./img/image-20191230102022829.png)
...
* 基因突变：某基因随机变成了另一个完全不同的基因。**基因突变可以产生新的基因**，新基因表达的性状可能是有益的，也可能是有害的（**大多数情况下是有害的**）。**基因突变是产生种群多样性的主要原因**。**基因突变发生的概率很低**。
  ...
  ![image-20191228214819773.png](./img/image-20191228214819773.png)

* 基因重组：两条染色体的部分片段发生了随机交换。**基因重组不会产生新的基因，但是可能将父代的一些优良基因片段集中到子代基因上**（当然，也有可能将父代不好的基因片段集中到子代基因上）。**基因重组发生的概率也很低，但是比基因突变的概率高**。

  ![image-20191228214241023.png](./img/image-20191228214241023.png)
...
![image-20191230102045319.png](./img/image-20191230102045319.png)
